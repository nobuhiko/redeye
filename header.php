...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/smart.css?v=4" media="all">

<?php else: ?>

<meta name="viewport" content="width=1024, maximum-scale=1, user-scalable=yes">
<link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); ?>?v=5" media="all">
<?php endif; ?>
